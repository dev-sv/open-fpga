...
# 
add_interface aclk conduit end
set_interface_property aclk associatedClock clock
set_interface_property aclk associatedReset reset
...
add_interface_port aclk aclk aclk Input 1
