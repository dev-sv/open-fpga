...
module hdmi_qsys_mm_interconnect_0 (
		...
		input  wire [29:0] hdmi_avl_0_avalon_master_address,                                   //                                     hdmi_avl_0_avalon_master.address
		output wire        hdmi_avl_0_avalon_master_waitrequest,                               //                                                             .waitrequest
		input  wire [10:0] hdmi_avl_0_avalon_master_burstcount,                                //                                                             .burstcount
		input  wire [3:0]  hdmi_avl_0_avalon_master_byteenable,                                //                                                             .byteenable
		input  wire        hdmi_avl_0_avalon_master_read,                                      //                                                             .read
		output wire [31:0] hdmi_avl_0_avalon_master_readdata,                                  //                                                             .readdata
		output wire        hdmi_avl_0_avalon_master_readdatavalid,                             //                                                             .readdatavalid
		input  wire        hdmi_avl_0_avalon_master_write,                                     //                                                             .write
		input  wire [31:0] hdmi_avl_0_avalon_master_writedata,                                 //                                                             .writedata
	...
	wire          hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_waitrequest;   // hdmi_avl_0_avalon_master_agent:av_waitrequest -> hdmi_avl_0_avalon_master_translator:uav_waitrequest
	wire   [31:0] hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_readdata;      // hdmi_avl_0_avalon_master_agent:av_readdata -> hdmi_avl_0_avalon_master_translator:uav_readdata
	wire          hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_debugaccess;   // hdmi_avl_0_avalon_master_translator:uav_debugaccess -> hdmi_avl_0_avalon_master_agent:av_debugaccess
	wire   [31:0] hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_address;       // hdmi_avl_0_avalon_master_translator:uav_address -> hdmi_avl_0_avalon_master_agent:av_address
	wire          hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_read;          // hdmi_avl_0_avalon_master_translator:uav_read -> hdmi_avl_0_avalon_master_agent:av_read
	wire    [3:0] hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_byteenable;    // hdmi_avl_0_avalon_master_translator:uav_byteenable -> hdmi_avl_0_avalon_master_agent:av_byteenable
	wire          hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_readdatavalid; // hdmi_avl_0_avalon_master_agent:av_readdatavalid -> hdmi_avl_0_avalon_master_translator:uav_readdatavalid
	wire          hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_lock;          // hdmi_avl_0_avalon_master_translator:uav_lock -> hdmi_avl_0_avalon_master_agent:av_lock
	wire          hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_write;         // hdmi_avl_0_avalon_master_translator:uav_write -> hdmi_avl_0_avalon_master_agent:av_write
	wire   [31:0] hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_writedata;     // hdmi_avl_0_avalon_master_translator:uav_writedata -> hdmi_avl_0_avalon_master_agent:av_writedata
	wire   [12:0] hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_burstcount;    // hdmi_avl_0_avalon_master_translator:uav_burstcount -> hdmi_avl_0_avalon_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                           // rsp_mux:src_valid -> hdmi_avl_0_avalon_master_agent:rp_valid
	wire  [111:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> hdmi_avl_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                           // hdmi_avl_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> hdmi_avl_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                   // rsp_mux:src_startofpacket -> hdmi_avl_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                     // rsp_mux:src_endofpacket -> hdmi_avl_0_avalon_master_agent:rp_endofpacket
	...
	wire  [112:0] hps_0_f2h_sdram0_data_agent_rf_source_data;                                  // hps_0_f2h_sdram0_data_agent:rf_source_data -> hps_0_f2h_sdram0_data_agent_rsp_fifo:in_data
	...
	wire  [112:0] hps_0_f2h_sdram0_data_agent_rsp_fifo_out_data;                               // hps_0_f2h_sdram0_data_agent_rsp_fifo:out_data -> hps_0_f2h_sdram0_data_agent:rf_sink_data
	...
	wire          hdmi_avl_0_avalon_master_agent_cp_valid;                                     // hdmi_avl_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [111:0] hdmi_avl_0_avalon_master_agent_cp_data;                                      // hdmi_avl_0_avalon_master_agent:cp_data -> router:sink_data
	wire          hdmi_avl_0_avalon_master_agent_cp_ready;                                     // router:sink_ready -> hdmi_avl_0_avalon_master_agent:cp_ready
	wire          hdmi_avl_0_avalon_master_agent_cp_startofpacket;                             // hdmi_avl_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          hdmi_avl_0_avalon_master_agent_cp_endofpacket;                               // hdmi_avl_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [111:0] hps_0_f2h_sdram0_data_agent_rp_data;                                         // hps_0_f2h_sdram0_data_agent:rp_data -> router_001:sink_data
	...
	wire  [111:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> hps_0_f2h_sdram0_data_burst_adapter:sink0_data
	...
	wire  [111:0] hps_0_f2h_sdram0_data_burst_adapter_source0_data;                            // hps_0_f2h_sdram0_data_burst_adapter:source0_data -> hps_0_f2h_sdram0_data_agent:cp_data
	...
	) hdmi_avl_0_avalon_master_translator (
		.clk                    (pll_0_outclk0_clk),                                                           //                       clk.clk
		.reset                  (hdmi_avl_0_reset_reset_bridge_in_reset_reset),                                //                     reset.reset
		.uav_address            (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (hdmi_avl_0_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (hdmi_avl_0_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (hdmi_avl_0_avalon_master_burstcount),                                         //                          .burstcount
		.av_byteenable          (hdmi_avl_0_avalon_master_byteenable),                                         //                          .byteenable
		.av_read                (hdmi_avl_0_avalon_master_read),                                               //                          .read
		.av_readdata            (hdmi_avl_0_avalon_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (hdmi_avl_0_avalon_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (hdmi_avl_0_avalon_master_write),                                              //                          .write
		.av_writedata           (hdmi_avl_0_avalon_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) hdmi_avl_0_avalon_master_agent (
		.clk                   (pll_0_outclk0_clk),                                                           //       clk.clk
		.reset                 (hdmi_avl_0_reset_reset_bridge_in_reset_reset),                                // clk_reset.reset
		.av_address            (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (hdmi_avl_0_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (hdmi_avl_0_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (hdmi_avl_0_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (hdmi_avl_0_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (hdmi_avl_0_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (hdmi_avl_0_avalon_master_agent_cp_ready),                                     //          .ready
	...
	hdmi_qsys_mm_interconnect_0_router router (
		.sink_ready         (hdmi_avl_0_avalon_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (hdmi_avl_0_avalon_master_agent_cp_valid),         //          .valid
		.sink_data          (hdmi_avl_0_avalon_master_agent_cp_data),          //          .data
		.sink_startofpacket (hdmi_avl_0_avalon_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (hdmi_avl_0_avalon_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (pll_0_outclk0_clk),                               //       clk.clk
		.reset              (hdmi_avl_0_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
