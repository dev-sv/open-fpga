...
`timescale 1 ps / 1 ps
module hdmi_qsys_mm_interconnect_2 (
		...
		input  wire [10:0] mm_bridge_0_m0_burstcount,                                          //                                                             .burstcount
	...
	wire   [12:0] mm_bridge_0_m0_translator_avalon_universal_master_0_burstcount;    // mm_bridge_0_m0_translator:uav_burstcount -> mm_bridge_0_m0_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                 // rsp_mux:src_valid -> mm_bridge_0_m0_agent:rp_valid
	wire  [111:0] rsp_mux_src_data;                                                  // rsp_mux:src_data -> mm_bridge_0_m0_agent:rp_data
	...
	wire  [111:0] mm_bridge_0_m0_agent_cp_data;                                      // mm_bridge_0_m0_agent:cp_data -> router:sink_data
	...
	hdmi_qsys_mm_interconnect_2_router router (
	...
	hdmi_qsys_mm_interconnect_2_router_001 router_001 (
	...
	hdmi_qsys_mm_interconnect_2_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hdmi_qsys_mm_interconnect_2_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                      //       clk.clk
		.reset               (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hdmi_qsys_mm_interconnect_2_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hdmi_qsys_mm_interconnect_2_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hdmi_qsys_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
